...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'soloconnect-integration.us-west-2.elasticbeanstalk.com', 'soloconnect-production.us-west-2.elasticbeanstalk.com']
